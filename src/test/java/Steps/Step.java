...
public class Step {
    ...
    public void que_el_cliente_se_encuentra_en_el_modulo_de_consultas_y_extractos_en_el_submodulo_extracto_por_producto(DataTable dataFeature) throws IOException, InterruptedException {
        log.info("-------------- Inicio Test ----------------");
        List<Map<String, String>> data=dataFeature.asMaps();
        Login login = new Login(driver);
        login.login(data.get(0).get("User"));
